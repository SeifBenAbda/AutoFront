  ...
  return (
    ...
    >
      <div className="absolute top-4 left-4">
        <h1 className="text-2xl font-bold text-darkGrey font-oswald">AUTO PRO</h1>
      </div>
      <div className="flex-grow flex items-center justify-center z-10">
        <div className="w-full max-w-md bg-darkGrey p-8 rounded-xl shadow-md m-4">
          <h1 className="text-3xl font-bold mb-6 text-center font-oswald text-white">Connexion</h1>
          <LoginForm />
        </div>
      </div>
      <footer className="text-darkGrey py-4">
