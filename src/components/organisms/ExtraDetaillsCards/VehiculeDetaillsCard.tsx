        ...
        <Card className="bg-lightWhite border border-lightWhite flex flex-col overflow-y-auto">
            ...
            <div className="flex flex-row justify-between">
                <CardContent className="w-full">
                    <label className="block text-sm font-medium text-highGrey">Couleur du véhicule</label>
                    <Input
                        type="text"
                ...
                <CardContent className="w-full">
                    <label className="block text-sm font-medium text-highGrey">Dernier véhicule possédé</label>
                    <Input
                        type="text"
            ...
            {devis.StatusDevis === "Facture" &&
                ...
                <>
                    <CardTitle className="text-xl text-highGrey font-oswald text-left w-full pl-3 mb-2">Informations après-vente</CardTitle>
                    <CardContent className="w-full">
                        <label className="block text-sm font-medium text-highGrey">Immatriculation</label>
                        <Input
                            maxLength={30}
                    ...
                    <CardContent className="w-full">
                        <label className="block text-sm font-medium text-highGrey">Date de Livraison</label>
                        <DatePicker
