...
const Header: React.FC = () => {
  return (
    <header className="bg-lightWhite p-2 w-full flex items-center justify-between border  border-lightWhite sticky top-0 left-0 z-10 "> {/* h-16 sets the height to 4rem */}
